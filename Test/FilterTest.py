...
for i in range(31):
    file_path = "file_stereo"+str(i)+".wav"
    ...
    left_channel_short = left_channel[12000:]
    right_channel_short = right_channel[12000:]
    fs = sr
    lowcut = 200
    highcut = 20000
    print("Nonfiltered:")
    print(343*1000* gcc_phat(right_channel_short,left_channel_short,sr))
    left_channel = butter_bandpass_filter(left_channel, lowcut, highcut, fs, order=2)
    right_channel = butter_bandpass_filter(right_channel, lowcut, highcut, fs, order=2)
    ...
    output_file_path = "file_stereo"+str(i)+"filtered.wav"
    ...
    stereo_data = np.empty(len(left_channel_short) + len(right_channel_short), dtype=data.dtype)
    stereo_data[::2] = left_channel_short
    stereo_data[1::2] = right_channel_short
