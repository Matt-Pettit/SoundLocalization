...
def post_array():
    ...
    if not connectedrecord1:
        ...
        pi1_2_latest_L=butter_bandpass_filter(pi1_2_latest_L, lowcut, highcut, fs, order=6)
        pi1_2_latest_R=butter_bandpass_filter(pi1_2_latest_R, lowcut, highcut, fs, order=6)
        pi3_4_latest_L=butter_bandpass_filter(pi3_4_latest_L, lowcut, highcut, fs, order=6)
        pi3_4_latest_R=butter_bandpass_filter(pi3_4_latest_R, lowcut, highcut, fs, order=6)
